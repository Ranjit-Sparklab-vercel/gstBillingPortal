                        ...
                        <>
                          ...
                          <div className="text-sm space-y-1">
                            ...
                            {preparePrintData()!.shipToAddress && (() => {
                              const shipToAddress = preparePrintData()!.shipToAddress!;
                              return (
                                <div>
                                  <span className="font-semibold">Address:</span><br />
                                  {shipToAddress.line1}
                                  {shipToAddress.line2 && <>, {shipToAddress.line2}</>}
                                  <br />
                                  {shipToAddress.city}
                                  <br />
                                  {shipToAddress.pin} - {shipToAddress.state}
                                </div>
                              );
                            })()}
                          </div>
                    ...
                    <tr>
                      <td className="border border-gray-400 px-4 py-2 w-1/3">
                        {preparePrintData()!.ewaybill && (() => {
                          const ewaybill = preparePrintData()!.ewaybill!;
                          return (
                            <>
                              <span className="font-semibold text-sm">E-Waybill No:</span><br />
                              <span className="text-sm">{ewaybill.ewayBillNo}</span>
                            </>
                          );
                        })()}
                      </td>
                        ...
                        {preparePrintData()!.ewaybill && (() => {
                          ...
                          return (
                            <>
                              ...
                              <span className="text-sm">{ewaybill.ewayBillDate}</span>
                            </>
                          );
                        })()}
                      </td>
